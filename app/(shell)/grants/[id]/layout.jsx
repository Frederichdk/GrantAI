  ...
  return (
    <div className="w-full h-full p-6 flex flex-row gap-8 ">
      ...
      <div className="flex-1 flex flex-col ">
        <div className="w-full h-16 px-6 flex flex-row justify-between items-center bg-neutral-800/70">
          <div className="flex flex-row gap-2 items-center">
            <BsStars size={26} className="text-text-sec" />
            <h2 className="text-xl text-text-pri/80">Grant Search Session</h2>
          </div>
          <div className="w-10 h-10 flex justify-center items-center rounded-xl text-text-sec  hover:bg-neutral-700/40 hover:text-text-pri">
            <TbDotsVertical size={16} />
          </div>
        </div>
        <div className="w-full flex-1 flex flex-col bg-neutral-800/70">
